...
const system={version:"1.0.0",phase:10,checked_at:"2026-09-08T10:00:00Z",database:{status:"ready",schema_version:"005_drug_response_modeling"},counts:{samples:566,variants:506,genes:10,drugs:10,pathways:72},datasets:[],limitations:[]};
