...
const options={dataset,datasets:[dataset],drugs,features,algorithms:[{id:"logistic",name:"Regularized logistic regression"},{id:"random_forest",name:"Random forest"},{id:"gradient_boosting",name:"Histogram gradient boosting"}],mutation_groups:[{gene:"TP53",mutated:30,wild_type:30},{gene:"KRAS",mutated:11,wild_type:49}],protocol:{cross_validation:"5 folds × 3 repeats, stratified, seed 20260908",target:"Above median",positive_class:"more sensitive",pipeline:"Median imputation and scaling fit inside each training fold"}};
