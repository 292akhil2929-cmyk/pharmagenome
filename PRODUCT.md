...
## Open Decisions
Neon PostgreSQL is connected privately through Vercel. Phase 3 genomic explorers are implemented; sequence tools are next; drug/pathway sources and response data remain pending.
