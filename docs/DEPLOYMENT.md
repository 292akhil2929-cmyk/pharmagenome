...
The initial schema migration runs in the trusted backend build, never in an HTTP endpoint. No scientific seed data is loaded. Database readiness must return 200 and schema_version 001_foundation after deploy.
